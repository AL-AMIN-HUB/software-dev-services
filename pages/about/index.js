    ...
    <section className={`${styles.main_section} container_fluid`}>
      ...
      <div className={styles.about_head_text}>
        ...
        <p>
          ...
          for instance, developed such an auction platform as Scandy. TS4U has already had successful experience in game development, starting at the
          game Time of silence once.
          <br />
          <br />
      ...
      <div className={styles.second_row}>
        <div className={styles.col_second}>
          ...
          <p className={styles.mid_paragraph}>
            ...
            process, for the fulfillment of its obligations, as well as for the confidence reposed by our customers, providing guaranteed maintenance
        ...
        <div className={styles.col_second}>
          ...
          <p className={styles.mid_paragraph}>
            For us, it means professional fulfillment of our obligations, based on a deep understanding of development processes, solid knowledge, and
            experience, compliance with safety requirements and ensuring absolute confidentiality.
          </p>
        </div>
        <div className={styles.col_second}>
          <h2>Efficiency</h2>
